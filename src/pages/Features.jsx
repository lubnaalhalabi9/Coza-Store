  ...
  return (
    <div className="bg-white pt-25 pb-10 md:pt-36 relative min-h-screen "> 
      <div className=" container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl ">
        ...
        {/* العمود 2: ملخص السلة (CART TOTALS) */}
                                    ...
                                    <div className=" text-gray5 absolute bottom-full left-0 w-full border border-white2 bg-white shadow-lg mb-1 z-30 max-h-40 overflow-y-auto">
                                        {countryOptions.map((option) => (
                                            <div 
                                                ...
                                                className={`p-2 text-sm text-gray5 cursor-pointer transition whitespace-nowrap
            ...
            <div className="mt-4 px-3 pb-8 py-4">
              <a href='/Features'>
                <button
                    ...
                    className="w-full py-3 text-white uppercase text-base font-semibold tracking-wider transition duration-200 cursor-pointer
                               rounded-full shadow-lg 
                              bg-dark1 hover:bg-blue1"
                >
                    PROCEED TO CHECKOUT
                </button>
                </a>
